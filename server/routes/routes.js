...
const { registerVendor, verifyVendorEmail, resendOtp, loginVendor, logoutVendor, changeVendorPassword, changeVendorCategory, deleteVendorAccount, updateVendorDetails } = require('../controllers/vendor.controller');
...
router.post('/update_account', updateVendorDetails);
